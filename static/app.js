...
const iconHelp       = () => icon('<circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/>', 20, 20);
...
const iconTrash      = () => icon('<polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"/>');
    ...
    <div class="modal-body">
      ...
      <form id="help-form" autocomplete="off">
        <div class="form-group">
          <label for="help-subject" class="form-label">Subject</label>
          <input id="help-subject" name="subject" type="text" class="form-input" maxlength="200" required placeholder="One-line summary" />
        </div>
        <div class="form-group">
          <label for="help-message" class="form-label">Message</label>
          <textarea id="help-message" name="message" class="form-input" rows="6" maxlength="5000" required placeholder="What happened? What were you trying to do?"></textarea>
        </div>
        <div style="display:flex;gap:8px;justify-content:flex-end;">
          <button type="button" class="btn btn-ghost" onclick="closeModal()">Cancel</button>
          <button type="submit" class="btn btn-primary" id="help-submit">Send</button>
        </div>
      </form>
    </div>
  `);
